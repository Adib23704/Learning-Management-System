    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-sm text-neutral-500">
          Comprehensive platform-wide performance metrics and insights.
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Daily new enrollments across the platform
          </CardDescription>
        </CardHeader>
        <CardContent>
          {isGrowthLoading ? (
            ...
            <ResponsiveContainer width="100%" height={320}>
              <AreaChart data={growthData}>
                ...
                <Area
                  ...
                  strokeWidth={2}
                  fill="url(#saAnalyticsEnrollmentGrad)"
                  name="Enrollments"
                />
              </AreaChart>
            </ResponsiveContainer>
