...
type SuperAdminCreateUserInput = z.infer<typeof superAdminCreateUserSchema>;
...
export default function SuperAdminUsersPage() {
  ...
  const form = useForm<SuperAdminCreateUserInput>({
    resolver: zodResolver(superAdminCreateUserSchema),
    defaultValues: {
      firstName: "",
      lastName: "",
      email: "",
  ...
  const handleCreateUser = async (values: SuperAdminCreateUserInput) => {
    try {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Manage all platform users including admins"
        actions={
            ...
            >
              <Select
                ...
                onValueChange={(val) =>
                  form.setValue(
                    "role",
                    val as SuperAdminCreateUserInput["role"],
                  )
                }
              >
                <SelectTrigger>
