    ...
    () => [
      ...
      },
      {
        ...
        render: (item) => {
          const c = item as unknown as Course;
          return c.isFree ? (
            <span className="font-medium text-accent-600">Free</span>
          ) : (
            <span className="text-neutral-600">{formatCurrency(c.price)}</span>
          );
        },
      },
      {
  ...
  return (
    <div className="space-y-6">
      ...
      <ConfirmDialog
        ...
        title="Delete Course"
        description={`Are you sure you want to permanently delete "${deleteConfirm.courseTitle}"? All lessons, enrollments, and progress data will be lost.`}
        confirmText="Delete"
        variant="danger"
